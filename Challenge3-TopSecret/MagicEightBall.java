//UIUC CS125 FALL 2012 MP. File: MagicEightBall.java, CS125 Project: Challenge3-TopSecret, Version: 2012-09-22T01:39:04-0500.114506000
 /**
...
public class MagicEightBall {
	...
	public static void main(String[] args) {
		...
		if (hours<10  && !happy ) {
			...
			if (social && hours>20 &&happy) {
				TextIO.put("Ace CS125 Exam");
			} else if (hours>15 &&social) {
