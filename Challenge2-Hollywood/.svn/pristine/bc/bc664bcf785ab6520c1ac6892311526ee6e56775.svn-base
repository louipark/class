//UIUC CS125 FALL 2012 MP. File: AutomaticScoreCheckl.java, CS125 Project: Challenge2-Hollywood, Version: 2012-09-14T17:11:15-0500.186579000
 ...
 *
 */
public class AutomaticScoreCheckl  {
	...
	private static void checkFileForCompileError(File file) {
		...
		if ("|CheckInputOutput|AutomaticScoreCheckl|TextIO|".contains("|"
