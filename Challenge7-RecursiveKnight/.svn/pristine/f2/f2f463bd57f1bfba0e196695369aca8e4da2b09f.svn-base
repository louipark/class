//UIUC CS125 FALL 2012 MP. File: RobotLinkTest.java, CS125 Project: Challenge7-RecursiveKnight, Version: 2012-11-09T13:47:46-0600.831004000
...
public class RobotLinkTest extends TestCase {
	...
	private void checkRobotUnmodified() {
		...
		for(int i=0;i<methods.length;i++) {
			...
			if(found) foundCount++;
			else fail(msg+" "+name+" not allowed");
		}
	}
