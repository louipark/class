...
public class LostFormActivity extends Activity{
	...
	private void addListenerOnSpinnerItemSelection() {
		...
		descL = (EditText)findViewById(R.id.descL);
	...
	public void submitForm(View view){
		...
		Form f = new Form();
		if (f.validate(descL.getText().toString(), cat, spnrSubCat.getSelectedItem().toString(), company)){
			...
			intent.putExtra("desc", descL.getText().toString());
			
			intent.putExtra("lost_found", "lost");
