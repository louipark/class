...
public class LostFormActivityTest extends ActivityInstrumentationTestCase2 < SignInActivity > {

public LostFormActivityTest() {
...
public void addLostForm() throws Exception {
	...
	List<NameValuePair> params = setParams("admin@test.com", "", "", "red", "40.689060, -74.044636", 
			"electronics", "laptop", "alienware", "Alienware M17x", "10", "2015-04-02 00:00:00");
	
	JSONObject jsonRegister = jParser.makeHttpRequest(
			"http://lostandfound.web.engr.illinois.edu/lostForm.php", "POST", params);
	
	//super.setUp();
}

public void testLostFormSubmission() throws Exception{
